...
# Устанавливаем основным типом данных int8
torch.set_default_dtype(torch.int8)

# ----------------------------------------
#         Инцициализация нейронной сети
# ----------------------------------------
def weights_init(net, init_type = 'normal', init_gain = 0.02):
    ...
    # Инициализация весов гауссовским распрделенением со средним значение 0 и сревднеквадратичным отклонением 0.02
    """
    def init_func(m):
...
class Generator (nn.Module):
    def __init__(self):
        ...
        self.fm = nn.Conv2d(out_channel, 1, 3, 1, 1)  # Карта-внимания
